...
std::shared_ptr<Renderer::ShaderProgram> ResourceManager::getShaderProgram(const std::string& shaderName)
{
	...
	std::cerr << "Can's find the shader program" << shaderName << std::endl;
	return nullptr;
}
...
std::shared_ptr<Renderer::Texture2D> ResourceManager::getTexture(const std::string& textureName)
{
	...
	std::cerr << "Can's find the texture" << textureName << std::endl;
	return nullptr;
																...
																const std::string& subTextureName)
{
	...
	if (!pTexture)
	{
		std::cerr << "Can's find the texture" << textureName << " for the sprite: " << spriteName << std::endl;
	}

	auto pShader = getShaderProgram(shaderName);
	if (!pShader)
	{
		std::cerr << "Can's find the shader" << shaderName << " for the sprite: " << spriteName << std::endl;
	}
...
std::shared_ptr<Renderer::Sprite> ResourceManager::getSprite(const std::string& spriteName)
{
	...
	std::cerr << "Can's find the sprite" << spriteName << std::endl;
	return nullptr;
}
...
std::shared_ptr<Renderer::AnimatedSprite> ResourceManager::getAnimatedSprite(const std::string& spriteName)
{
	...
	std::cerr << "Can's find the animated sprite" << spriteName << std::endl;
	return nullptr;
}
